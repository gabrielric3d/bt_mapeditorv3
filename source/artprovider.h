...
#define ART_WORLDBOSS_BRUSH wxART_MAKE_ART_ID(ART_WORLDBOSS_BRUSH)
...
#define ART_WALL_BORDERS_TOOLBAR wxART_MAKE_ART_ID(ART_WALL_BORDERS_TOOLBAR)
#define ART_MOUNTAIN_OVERLAY_TOOLBAR wxART_MAKE_ART_ID(ART_MOUNTAIN_OVERLAY_TOOLBAR)
#define ART_STAIR_DIRECTION_TOOLBAR wxART_MAKE_ART_ID(ART_STAIR_DIRECTION_TOOLBAR)
